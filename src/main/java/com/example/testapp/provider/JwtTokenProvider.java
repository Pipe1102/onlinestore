package com.example.testapp.provider;
...
public class JwtTokenProvider {
    ...
    public String generateJwtToken(UserPrincipal userPrincipal){
        ...
        return JWT.create().withIssuer(SecurityConstants.GET_ARRAYS_LLC)
                ...
                .withExpiresAt(new Date(System.currentTimeMillis()+ SecurityConstants.EXPIRTAION_TIME))
    ...
    public Authentication getAuthentication(String username, List<GrantedAuthority> grantedAuthorities, HttpServletRequest request){
